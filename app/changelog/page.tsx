  ...
  const releases: ReleaseItem[] = [
    {
      ...
      title: {
        ko: "모던 Linear / Vercel 스타일 프리미엄 UI 리뉴얼 & www 최적화",
        en: "Major UI Renewal: Modern Linear & Vercel Aesthetic with Dynamic Category Glows",
        ja: "UI大幅リニューアル: モダン Linear / Vercel スタイル＆カテゴリ別ネオングロー導入",
        es: "Gran Renovación de UI: Estilo Moderno Linear / Vercel y Brillos de Neón",
        zh: "UI 重磅焕新: 现代 Linear / Vercel 极简暗黑毛玻璃风格与动态霓虹微动效",
        fr: "Refonte Majeure de l'UI: Style Moderne Linear / Vercel avec Effets Néon Dynamiques",
      },
      changes: {
        ko: [
          ...
          "🌐 www 도메인 자동 301 리디렉션 구축: www.desktools.run 접속 시 표준 도메인으로의 완벽한 SEO 및 구글 애드센스 크롤러 호환성 확보.",
        ],
        en: [
          ...
          "🌐 Canonical www 301 Redirect: Configured permanent redirect from www.desktools.run to apex domain for optimal SEO and Google AdSense compliance.",
        ],
        ja: [
          ...
          "🌐 wwwドメイン自動301リダイレクト構築: www.desktools.runからのアクセスを正規ドメインへ転送し、SEOおよびGoogle AdSenseクローラーに対応。",
        ],
        es: [
          ...
          "🌐 Redirección Canónica 301 para www: Redirección permanente desde www.desktools.run para cumplimiento con SEO y AdSense.",
        ],
        zh: [
          ...
          "🌐 www 域名全自动 301 永久重定向: 完美兼容 www 访问规范，提升 SEO 权重并确保 Google AdSense 爬虫畅通无阻。",
        ],
        fr: [
          ...
          "🌐 Redirection 301 pour www: Redirection permanente pour l'optimisation SEO et la conformité AdSense.",
        ],
      },
    },
    {
