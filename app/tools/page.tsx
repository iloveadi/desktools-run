...
import { Search, Grid, ArrowRight, Sparkles } from "lucide-react";
...
export default function ToolsCatalogPage() {
  ...
  const categories = ["All", "PDF Tools", "Image Tools", "Dev Tools", "Converter", "Text & Formatting"];
                ...
                >
                  <div>
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "12px" }}>
                      <span style={{ fontSize: "11px", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.05em", color: "#818cf8", padding: "4px 8px", borderRadius: "6px", background: "rgba(99,102,241,0.12)" }}>
                        {tool.category}
                      </span>
                      {tool.badge && (
                        <span style={{ fontSize: "11px", fontWeight: 700, color: "#f43f5e", padding: "2px 8px", borderRadius: "100px", background: "rgba(244,63,94,0.12)" }}>
                          {tool.badge}
                        </span>
                      )}
                    </div>
