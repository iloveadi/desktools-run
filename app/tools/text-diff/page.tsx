      ...
      <main style={{ flex: 1, paddingBottom: "80px" }}>
        ...
        <section style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 24px", display: "flex", flexDirection: "column", gap: "24px" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px" }}>
            ...
            <div className="glass-card" style={{ padding: "20px", display: "flex", flexDirection: "column", gap: "10px" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <span style={{ fontSize: "14px", fontWeight: 700, color: "var(--text-primary)" }}>Original Text (A)</span>
                <button onClick={() => setTextA("")} style={{ background: "none", border: "none", color: "var(--text-muted)", fontSize: "12px", cursor: "pointer" }}>Clear</button>
              </div>
              <textarea
                rows={8}
                value={textA}
            ...
            <div className="glass-card" style={{ padding: "20px", display: "flex", flexDirection: "column", gap: "10px" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <span style={{ fontSize: "14px", fontWeight: 700, color: "#818cf8" }}>Modified Text (B)</span>
                <button onClick={() => setTextB("")} style={{ background: "none", border: "none", color: "var(--text-muted)", fontSize: "12px", cursor: "pointer" }}>Clear</button>
              </div>
              <textarea
                rows={8}
                value={textB}
          ...
          <div className="glass-card" style={{ padding: "24px", display: "flex", flexDirection: "column", gap: "16px" }}>
            <h3 style={{ fontSize: "16px", fontWeight: 800, color: "var(--text-primary)" }}>Line-by-Line Comparison Diff</h3>
        ...
        <ToolGuide
          ...
          aboutTitle="What is Text Diff Checker?"
          aboutDesc="Compare two text blocks and highlight line differences side-by-side in your browser."
          howTitle="How to Use Text Diff"
          steps={["1. Paste original text into Left Panel A.", "2. Paste modified text into Right Panel B.", "3. View instant red/green highlighted line differences."]}
          faqs={[{ q: "Are text blocks uploaded anywhere?", a: "No, diff comparison logic runs 100% locally in your browser memory." }]}
        />
      </main>
      <Footer />
    </>
