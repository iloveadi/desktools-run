...
export const translations: Record<Locale, Translations> = {
  ...
  ja: {
    ...
    "imageConverter.guide.faq3A": "はい！複数の画像をまとめてアップロードし、「すべてダウンロード」で一括保存できます。",
  ...
  es: {
    ...
    "imageConverter.guide.faq3A": "¡Sí! Puedes subir la cantidad de imágenes que desees y convertirlas todas juntas con Descargar Todo.",
  ...
  zh: {
    ...
    "imageConverter.guide.faq3A": "支持！您可以一次性导入多张图片，并一键导出所有转换成果。",
  ...
  fr: {
    ...
    "imageConverter.guide.faq3A": "Oui ! Vous pouvez importer autant d'images que souhaité et tout convertir en un clic.",
