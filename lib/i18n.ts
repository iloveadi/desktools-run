...
export const translations: Record<Locale, Translations> = {
  ...
  ja: {
    ...
    "imageCompress.guide.faq3A": "制限はありません。完全無料で何枚でも圧縮できます。",
  ...
  es: {
    ...
    "imageCompress.guide.faq3A": "¡No! Puedes comprimir todas las imágenes que desees sin restricciones y 100% gratis.",
  ...
  zh: {
    ...
    "imageCompress.guide.faq3A": "完全没有！您可以无限制免费压缩任意数量的图片。",
  ...
  fr: {
    ...
    "imageCompress.guide.faq3A": "Non ! Vous pouvez compresser autant d'images que vous le souhaitez, 100% gratuitement.",
