...
export const translations: Record<Locale, Translations> = {
  ...
  en: {
    ...
    "exifRemover.hasExif": "EXIF Metadata Found",
    "exifRemover.noExif": "No EXIF Data Found (Already Clean)",
    ...
    "exifRemover.cameraInfo": "Camera & Lens Info",
    "exifRemover.captureDate": "Date & Time Taken",
    "exifRemover.imageDetails": "Dimensions & Color Space",
    ...
    "faviconGen.previewTitle": "Browser & Mobile Preview",
    "faviconGen.tabPreview": "Browser Tab Preview",
...
// CSV to JSON
  ...
  ko: {
    ...
    "exifRemover.imageDetails": "해상도 및 컬러 스페이스",
    ...
    "faviconGen.previewTitle": "브라우저 & 모바일 미리보기",
    "faviconGen.tabPreview": "웹 브라우저 탭 미리보기",
    ...
    "faviconGen.guide.step1": "1. 정사각형 또는 고해상도 로고 이미지를 업로드합니다.",
    "faviconGen.guide.step2": "2. 배경색, 둥근 모서리 모양, 패딩 여백 옵션을 조정합니다.",
    "faviconGen.guide.step3": "3. '전체 파비콘 ZIP 패키지 일괄 다운로드'를 누르고 생성된 HTML 코드를 웹사이트 <head>에 복사하세요.",
    "faviconGen.guide.faq1Q": "로고 이미지가 서버에 저장되나요?",
    "faviconGen.guide.faq1A": "아닙니다. 모든 아이콘 리사이징, ICO 바이너리 합성, ZIP 압축 파일 생성이 100% 사용자 브라우저에서 수행됩니다.",
